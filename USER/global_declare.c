...
TD yaw_td_2 = {0, 0, 0, 1500, 0.001, 0};////////zuixia
 ...
 //视觉
ST_PID Pitch_SpeedPID_3 = {0, 0,7 , 0, 80, 0, 0, 0, 0, 0, 0, 0, 2048, 2000, 2000, 2000, 500};
ST_PID Pitch_PosPID_3 = {0, 0, 30, 0.2, 150, 0, 0, 0, 0, 0, 0, 0, 2048, 2000, 500, 500, 2};
TD pitch_td_3 = {0, 0, 0, 10000, 0.001, 0};
//ST_PID Pitch_SpeedPID_3 = {0, 0, 2, 0, 60, 0, 0, 0, 0, 0, 0, 0, 2048, 2000, 2000, 2000, 500};
//ST_PID Pitch_PosPID_3 = {0, 0, 90, 0.2, 195, 0, 0, 0, 0, 0, 0, 0, 2048, 2000, 500, 500, 2};
//TD pitch_td_3 = {0, 0, 0, 10000, 0.001, 0};
