...
*连接后，接收机便会每隔14ms通过DBus发送一帧数据（18字节）     *
*                                                            *
*DBus通信参数如下：                                          *
*                                                            *
*DBus参数            数值                                    *
...
#define KEY_PRESSED_OFFSET_R		((USHORT16)0x01<<8)
#define KEY_PRESSED_OFFSET_F		((USHORT16)0x01<<9)
#define KEY_PRESSED_OFFSET_G		((USHORT16)0x01<<10)
#define KEY_PRESSED_OFFSET_Z	    ((USHORT16)0x01<<11)
#define KEY_PRESSED_OFFSET_X	    ((USHORT16)0x01<<12)
#define KEY_PRESSED_OFFSET_C		((USHORT16)0x01<<13)
#define KEY_PRESSED_OFFSET_V		((USHORT16)0x01<<14)
#define KEY_PRESSED_OFFSET_B		((USHORT16)0x01<<15)
...
extern ST_DBUS DR16_rec;

//#define RC_ON   (system_monitor.USART1_fps>=60)
#define RC_ON   1
#endif
